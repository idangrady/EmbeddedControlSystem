...
#define profileStart_Subsystem1_offset 2
#define profileEnd_Subsystem1_offset   2

/* Code instrumentation offset(s) for model Subsystem1 */
#define taskTimeStart_Subsystem1_offset 0
#define taskTimeEnd_Subsystem1_offset  0
...
{
  taskTimeStart(taskTimeStart_Subsystem1_offset + sectionId);
}

void taskTimeEnd_Subsystem1(uint32_T sectionId)
{
  taskTimeEnd(taskTimeEnd_Subsystem1_offset + sectionId);
}
