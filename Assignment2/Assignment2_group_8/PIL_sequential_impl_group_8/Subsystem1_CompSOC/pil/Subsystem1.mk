...
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/computation/5lij0_ECS_Course_2023/PIL_Implementation/PIL_sequential_impl
S_FUNCTIONS             = xil_interface_lib.c xil_data_stream.c xil_services.c xil_interface.c xilcomms_rtiostream.c xil_rtiostream.c rtiostream_utils.c coder_assumptions_app.c coder_assumptions_data_stream.c coder_assumptions_rtiostream.c pil_main.c rtiostream_tcpip.c xil_instrumentation.c codeinstr_data_stream.c codeinstr_rtiostream.c
S_FUNCTIONS_LIB         = $(START_DIR)/Subsystem1_CompSOC/coderassumptions/lib/Subsystem1_ca.a
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  GENERATE_ASAP2=0 DOWNLOAD_TO_COMPSOC=0 DIALOG_OPTIONS="" ALTERNATIVE_GCC="" PROCESSOR_TILE=0 ISPROTECTINGMODEL=NOTPROTECTING STANDALONE_SUPPRESS_EXE=1 OPTS="-DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=1024 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=1024 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = ../instrumented/Subsystem1.o ../instrumented/monitor_app.o ../instrumented/memory_access.o
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/Subsystem1_CompSOC/instrumented \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
	...
	-I$(START_DIR)/Subsystem1_CompSOC/pil \
	-I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc \
	-I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils \
	-I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc \
	-I$(START_DIR)/Subsystem1_CompSOC/coderassumptions \
	-I$(MATLAB_ROOT)/extern/include/coder/connectivity/CodeInstrTgtAppSvc \
	-I/home/computation/CompSOC_ec_target/CompSOC_ec \
...
%$(OBJ_EXT) : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<

%$(OBJ_EXT) : $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<

%$(OBJ_EXT) : /home/computation/CompSOC_ec_target/CompSOC_ec/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<



%$(OBJ_EXT) : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<

%$(OBJ_EXT) : $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<

%$(OBJ_EXT) : /home/computation/CompSOC_ec_target/CompSOC_ec/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<
