...
extern void profileStart_Subsystem1(uint32_T);
extern void profileEnd_Subsystem1(uint32_T);
struct tag_RTM {
 ...
 *
 * hilite_system('PIL_simulation_monitoring_app/Subsystem1')    - opens subsystem PIL_simulation_monitoring_app/Subsystem1
 * hilite_system('PIL_simulation_monitoring_app/Subsystem1/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'PIL_simulation_monitoring_app'
 * '<S1>'   : 'PIL_simulation_monitoring_app/Subsystem1'
 */
