...
MODULES                 = control.c memory_access.c coder_profile_timer.c
...
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  GENERATE_ASAP2=0 DOWNLOAD_TO_COMPSOC=1 DIALOG_OPTIONS="" ALTERNATIVE_GCC="" PROCESSOR_TILE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=1000 -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
