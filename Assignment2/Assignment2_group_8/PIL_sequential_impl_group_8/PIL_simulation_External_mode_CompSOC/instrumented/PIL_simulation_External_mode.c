 ...
 * C/C++ source code generated on : Wed Mar 29 00:11:18 2023
 *
...
{
  /* S-Function (generate_control_input): '<Root>/S-Function2' */
  profileStart_P_454deff6677e0cc2(1U); /* original_line:33 */PID_controller();profileEnd_PIL_c11dff6f632b516b(1U); /* original_line:33 */
...
void PIL_simulation_External_mode_initialize(void)
{
  ...
  rtmSetTFinal(PIL_simulation_External_mode_M, 999.99);
  PIL_simulation_External_mode_M->Timing.stepSize0 = 0.03;

  /* External mode info */
  PIL_simulation_External_mode_M->Sizes.checksums[0] = (2922329552U);
  PIL_simulation_External_mode_M->Sizes.checksums[1] = (55661106U);
  PIL_simulation_External_mode_M->Sizes.checksums[2] = (1154629780U);
  PIL_simulation_External_mode_M->Sizes.checksums[3] = (3158969442U);
