 ...
 *
 * hilite_system('SIL_Simulation_Sequential_Implementation/Subsystem2')    - opens subsystem SIL_Simulation_Sequential_Implementation/Subsystem2
 * hilite_system('SIL_Simulation_Sequential_Implementation/Subsystem2/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'SIL_Simulation_Sequential_Implementation'
 * '<S1>'   : 'SIL_Simulation_Sequential_Implementation/Subsystem2'
 */
