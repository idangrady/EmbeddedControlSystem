 ...
 *
 * hilite_system('SIL_Simulation_Sequential_Implementation/Subsystem1')    - opens subsystem SIL_Simulation_Sequential_Implementation/Subsystem1
 * hilite_system('SIL_Simulation_Sequential_Implementation/Subsystem1/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'SIL_Simulation_Sequential_Implementation'
 * '<S1>'   : 'SIL_Simulation_Sequential_Implementation/Subsystem1'
 */
