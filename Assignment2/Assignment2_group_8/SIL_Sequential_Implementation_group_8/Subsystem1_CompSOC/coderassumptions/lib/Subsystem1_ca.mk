...
MODEL                   = Subsystem1_ca
MODULES                 = coder_assumptions_hwimpl.c coder_assumptions_flt.c Subsystem1_ca.c
MAKEFILE                = Subsystem1_ca.mk
...
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DCA_CHECK_FLOATING_POINT_ENABLED=1 -DCA_CHECK_LONG_LONG_ENABLED=1 -DCA_CHECK_DAZ_ENABLED=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
%$(OBJ_EXT) : $(RELATIVE_PATH_TO_ANCHOR)/Subsystem1_CompSOC/coderassumptions/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<
...
%$(OBJ_EXT) : $(RELATIVE_PATH_TO_ANCHOR)/Subsystem1_CompSOC/coderassumptions/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<
