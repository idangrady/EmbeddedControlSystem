 ...
 *    C source code generated on : 18-Mar-2023 19:28:39
 *
...
/**
     ...
     def.SFunctionName = 'sensing_task_Sfunction';
     def.OutputFcnSpec = 'void sensing_task(uint8 u1[12496], int16 y1[1], int16 y2[1],int16 y3[1], int16 y4[1])';
     def.HeaderFiles = {'sensing_task.h'};
     def.SourceFiles = {'sensing_task.c'};
...
#define S_FUNCTION_NAME  sensing_task_Sfunction
