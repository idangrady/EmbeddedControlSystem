/**
 * merging_task_Sfunction.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 = merging_task(int16 u1[1], int16 u2[1], int16 u3[1], int16 u4[1])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 18-Mar-2023 19:28:40
 *
...
/**
     ...
     def.SFunctionName = 'merging_task_Sfunction';
     def.OutputFcnSpec = 'single y1 = merging_task(int16 u1[1], int16 u2[1], int16 u3[1], int16 u4[1])';
     def.HeaderFiles = {'merging_task.h'};
     def.SourceFiles = {'merging_task.c'};
...
#define S_FUNCTION_NAME  merging_task_Sfunction
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "merging_task", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
