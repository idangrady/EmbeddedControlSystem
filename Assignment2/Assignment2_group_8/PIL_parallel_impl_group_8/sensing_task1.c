...
void hough_transform()
{
    ...
    float cost[NUMBER_OF_THETA] = {0.996195f , 0.997564f, 0.998630f, 0.999391f, 0.999848f, 1.000000f};
    float sint[NUMBER_OF_THETA] = {-0.087156f, -0.069756f, -0.052336f, -0.034899f, -0.017452f, 0.000000f};
