...
void hough_transform()
{
    ...
    uint8_t 	picture_lock = read_lock(PICTURE_LOCK_LOCATION_SENSING_2);
    ...
    {
        read_byte (rcv_img_data, PICTURE_LOCATION_SENSING_2, IMG_SIZE);
        ...
        write_float(data_peaks_test, DATA_PEAK_LOCATION_0_SENSING_2, 4);
        
        
        write_lock(LOCK, MERGING_LOCK_LOCATION_SENSING_2);
