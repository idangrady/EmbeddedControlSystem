...
{
  /* S-Function (generate_control_input): '<Root>/S-Function3' */
...
void PIL_simulation_External_mode_initialize(void)
{
  ...
  rtmSetTFinal(PIL_simulation_External_mode_M, 1000.0);
  PIL_simulation_External_mode_M->Timing.stepSize0 = 0.02;

  /* External mode info */
  PIL_simulation_External_mode_M->Sizes.checksums[0] = (2182539059U);
  PIL_simulation_External_mode_M->Sizes.checksums[1] = (1428073605U);
  PIL_simulation_External_mode_M->Sizes.checksums[2] = (1049703983U);
  PIL_simulation_External_mode_M->Sizes.checksums[3] = (2661197866U);
