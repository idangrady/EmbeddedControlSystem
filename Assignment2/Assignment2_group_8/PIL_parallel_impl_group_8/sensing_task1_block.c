 ...
 *    C source code generated on : 29-Mar-2023 12:54:37
 *
...
/**
     ...
     def.SFunctionName = 'sensing_task1_block';
     def.OutputFcnSpec = 'void hough_transform()';
     def.HeaderFiles = {'sensing_task1.h', 'memory_access.h', 'config.h', 'mapping.h'};
     def.SourceFiles = {'sensing_task1.c', 'memory_access.c'};
...
#define S_FUNCTION_NAME  sensing_task1_block
