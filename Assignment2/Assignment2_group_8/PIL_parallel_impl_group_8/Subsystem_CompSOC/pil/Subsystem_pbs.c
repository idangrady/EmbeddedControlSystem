...
#define S_FUNCTION_NAME                Subsystem_pbs
  ...
  memUnitSizeBytes)
{
  ...
  pCodeInstrServiceData->infoPath =
    "/home/computation/5lij0_ECS_Course_2023/PIL_Implementation/PIL_parallel_impl/Subsystem_CompSOC/pil";
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  /* using port based sample times */
  ssSetOutputPortSampleTime(S, 3, 0.03);
