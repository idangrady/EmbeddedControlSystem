...
#define profileStart_Subsystem_offset  2
#define profileEnd_Subsystem_offset    2

/* Code instrumentation offset(s) for model Subsystem */
#define taskTimeStart_Subsystem_offset 0
#define taskTimeEnd_Subsystem_offset   0
...
/* Code instrumentation method(s) for model Subsystem */
void taskTimeStart_Subsystem(uint32_T sectionId)
{
  taskTimeStart(taskTimeStart_Subsystem_offset + sectionId);
}

void taskTimeEnd_Subsystem(uint32_T sectionId)
{
  taskTimeEnd(taskTimeEnd_Subsystem_offset + sectionId);
}
