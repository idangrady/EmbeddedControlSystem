 ...
 *
 * PIL generated interface for code: "Subsystem"
 *
 */
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    taskTimeStart_Subsystem(1U);
    Subsystem_initialize();
    taskTimeEnd_Subsystem(1U);
  } else {
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU.In1[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 12496 * sizeof
            (uint8_T);
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    taskTimeStart_Subsystem(2U);
    Subsystem_step();
    taskTimeEnd_Subsystem(2U);
    break;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.Out2);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.Out3);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.Out4);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(uint32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.Out4);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 1 * sizeof(uint32_T);
          xil_fcnid0_task1_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
