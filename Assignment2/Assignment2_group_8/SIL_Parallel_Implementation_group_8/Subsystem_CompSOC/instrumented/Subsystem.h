 ...
 *
 * hilite_system('SIL_Simulation_Parallel_Implementation/Subsystem')    - opens subsystem SIL_Simulation_Parallel_Implementation/Subsystem
 * hilite_system('SIL_Simulation_Parallel_Implementation/Subsystem/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'SIL_Simulation_Parallel_Implementation'
 * '<S1>'   : 'SIL_Simulation_Parallel_Implementation/Subsystem'
 */
