 ...
 *
 * PIL generated interface for code: "Subsystem5"
 *
 */
...
static XILIOData xil_fcnid0_task1_output_u[9];
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    taskTimeStart_Subsystem5(1U);
    Subsystem5_initialize();
    taskTimeEnd_Subsystem5(1U);
  } else {
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    taskTimeStart_Subsystem5(2U);
    Subsystem5_step();
    taskTimeEnd_Subsystem5(2U);
    break;
