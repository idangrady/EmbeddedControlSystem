...
/* Code instrumentation offset(s) for model Subsystem5 */

/* Code instrumentation offset(s) for model Subsystem5 */
#define taskTimeStart_Subsystem5_offset 0
#define taskTimeEnd_Subsystem5_offset  0
...
/* Code instrumentation method(s) for model Subsystem5 */

/* Code instrumentation method(s) for model Subsystem5 */
void taskTimeStart_Subsystem5(uint32_T sectionId)
{
  taskTimeStart(taskTimeStart_Subsystem5_offset + sectionId);
}

void taskTimeEnd_Subsystem5(uint32_T sectionId)
{
  taskTimeEnd(taskTimeEnd_Subsystem5_offset + sectionId);
}
