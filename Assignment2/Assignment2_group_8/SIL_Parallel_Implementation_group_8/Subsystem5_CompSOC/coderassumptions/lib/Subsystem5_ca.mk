...
MODEL                   = Subsystem5_ca
MODULES                 = coder_assumptions_hwimpl.c coder_assumptions_flt.c Subsystem5_ca.c
...
%$(OBJ_EXT) : $(RELATIVE_PATH_TO_ANCHOR)/Subsystem5_CompSOC/coderassumptions/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<
...
%$(OBJ_EXT) : $(RELATIVE_PATH_TO_ANCHOR)/Subsystem5_CompSOC/coderassumptions/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<
