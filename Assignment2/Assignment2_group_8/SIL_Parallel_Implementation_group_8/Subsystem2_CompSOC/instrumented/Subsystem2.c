...
void Subsystem2_step(void)
{
   ...
   *  Outport: '<Root>/Out4'
   */
  profileStart_Subsystem2(1U); /* original_line:44 */sensing_task((uint8_T*)&rtU.In1[0], &rtY.Out1, &rtY.Out2, &rtY.Out3, &rtY.Out4);profileEnd_Subsystem2(1U); /* original_line:44 */
}
