 ...
 *
 * PIL generated interface for code: "Subsystem2"
 *
 */
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    taskTimeStart_Subsystem2(1U);
    Subsystem2_initialize();
    taskTimeEnd_Subsystem2(1U);
  } else {
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    taskTimeStart_Subsystem2(2U);
    Subsystem2_step();
    taskTimeEnd_Subsystem2(2U);
    break;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
...

        {
          ...
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(int16_T);
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.Out1);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 1 * sizeof(int16_T);
