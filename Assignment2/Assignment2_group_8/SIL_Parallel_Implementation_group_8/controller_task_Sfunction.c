/**
 * controller_task_Sfunction.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         single y1 =  controller_task(single u1, single u2)
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 18-Mar-2023 19:55:57
 *
...
/**
     ...
     def.SFunctionName = 'controller_task_Sfunction';
     def.OutputFcnSpec = 'single y1 =  controller_task(single u1, single u2)';
     def.HeaderFiles = {'control.h'};
     def.SourceFiles = {'control.c'};
...
#define S_FUNCTION_NAME  controller_task_Sfunction
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "controller_task", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
