/**
 * sensing_task1_Sfunction.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void sensing_task(uint8 u1[12496], int16 y1[1], int16 y2[1],int16 y3[1], int16 y4[1])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 18-Mar-2023 19:55:53
 *
...
/**
     ...
     def.SFunctionName = 'sensing_task1_Sfunction';
     def.OutputFcnSpec = 'void sensing_task(uint8 u1[12496], int16 y1[1], int16 y2[1],int16 y3[1], int16 y4[1])';
     def.HeaderFiles = {'sensing_task1.h'};
     def.SourceFiles = {'sensing_task1.c'};
...
#define S_FUNCTION_NAME  sensing_task1_Sfunction
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "sensing_task", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
