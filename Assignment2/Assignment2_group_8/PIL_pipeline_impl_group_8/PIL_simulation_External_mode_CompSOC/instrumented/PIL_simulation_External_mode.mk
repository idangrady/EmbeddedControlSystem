...
MODEL                   = PIL_simulation_External_mode
MODULES                 = sensing_task_2.c memory_access.c coder_profile_timer.c
MAKEFILE                = PIL_simulation_External_mode.mk
...
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  GENERATE_ASAP2=0 DOWNLOAD_TO_COMPSOC=1 DIALOG_OPTIONS="" ALTERNATIVE_GCC="" PROCESSOR_TILE=2 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2000 -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELLIB                  = PIL_simulation_External_modelib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/PIL_simulation_External_mode_CompSOC/instrumented \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
...
%$(OBJ_EXT) : $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/%.cpp
	echo Compiling: $<
	@$(CXX) -c $(CXXFLAGS) $<
...
%$(OBJ_EXT) : $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/%.c
	echo Compiling: $<
	@$(CC) -c $(CFLAGS) $<
