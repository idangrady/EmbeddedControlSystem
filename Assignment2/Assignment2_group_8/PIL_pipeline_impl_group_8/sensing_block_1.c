 ...
 *    C source code generated on : 29-Mar-2023 15:48:04
 *
...
/**
     ...
     def.SFunctionName = 'sensing_block_1';
     def.OutputFcnSpec = 'void hough_transform()';
     def.HeaderFiles = {'sensing_task.h', 'memory_access.h', 'config.h', 'mapping.h'};
     def.SourceFiles = {'sensing_task_1.c', 'memory_access.c'};
...
#define S_FUNCTION_NAME  sensing_block_1
