 ...
 *
 *         void monitor(uint8 u1[12496], single y1[1], uint8 y2[1], uint32 u2[1], single y3[2])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 29-Mar-2023 15:48:03
 *
...
/**
     ...
     def.SFunctionName = 'monitor_app_block_pipe';
     def.OutputFcnSpec = 'void monitor(uint8 u1[12496], single y1[1], uint8 y2[1], uint32 u2[1], single y3[2])';
...
#define S_FUNCTION_NAME  monitor_app_block_pipe
